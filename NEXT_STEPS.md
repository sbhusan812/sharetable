...
1. Volunteer applications and identity review.
2. Volunteer delivery tasks with pickup and recipient confirmation.
3. NGO accounts and large-food reservations.
4. Verification records and photo evidence.
5. Receiver and donor dashboards.
6. Notifications.
7. Donations through a payment provider, only after the core workflow is safe.
